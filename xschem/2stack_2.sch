...
device=resistor
m=1}
C {devices/vsource.sym} -120 440 0 0 {name=V2 value="SIN(0 0.3 5G)"
}
C {devices/gnd.sym} -120 470 0 0 {name=l7 lab=GND}
C {devices/vsource.sym} 710 -210 0 0 {name=V3 value=3.3}
C {devices/gnd.sym} 710 -180 0 0 {name=l5 lab=GND}
C {devices/res.sym} 1220 20 2 0 {name=rload
value=50
footprint=1206
device=resistor
m=1}
C {devices/gnd.sym} 1220 70 0 0 {name=l6 lab=GND}
C {devices/lab_wire.sym} -120 190 0 0 {name=l11 sig_type=std_logic lab=vin}
...
C {devices/res.sym} -120 360 0 0 {name=R10
value=50
footprint=1206
device=resistor
m=1}
C {devices/res.sym} -120 260 0 0 {name=R11
value=1m
footprint=1206
device=resistor
m=1}
C {devices/lab_wire.sym} -120 400 0 0 {name=l21 sig_type=std_logic lab=vs}
...
C {sky130_fd_pr/nfet_03v3_nvt.sym} 440 -50 0 1 {name=M4
L=0.5
W=4
nf=1
mult=32
...
C {devices/isource.sym} 420 -170 0 0 {name=I1 value=2.7m}
...
device=resistor
m=1}
C {devices/lab_wire.sym} 470 -90 0 0 {name=l17 sig_type=std_logic lab=vbiasu}
C {devices/lab_wire.sym} 470 20 0 0 {name=l24 sig_type=std_logic lab=vbiasl}
C {devices/gnd.sym} 920 120 0 0 {name=l25 lab=GND}
C {sky130_fd_pr/nfet_01v8.sym} 220 240 0 0 {name=M5
L=0.15
W=16
nf=1 
mult=4
...
C {sky130_fd_pr/pfet_01v8.sym} 220 140 0 0 {name=M6
L=0.15
W=32
nf=1
mult=4
...
C {devices/gnd.sym} 240 320 0 0 {name=l8 lab=GND}
C {devices/res.sym} 190 190 1 0 {name=R1
value=1k
footprint=1206
device=resistor
m=1}
C {devices/capa.sym} 80 190 1 0 {name=C2
m=1
value=1.7p
footprint=1206
device="ceramic capacitor"}
C {devices/capa.sym} 310 190 1 0 {name=C12
m=1
value=1.7p
footprint=1206
device="ceramic capacitor"}
C {devices/capa.sym} -40 190 1 0 {name=C13
m=1
value=0.2p
footprint=1206
device="ceramic capacitor"}
C {devices/ind.sym} 20 250 0 0 {name=L3
m=1
value=2.5n
footprint=1206
device=inductor}
C {devices/gnd.sym} 20 320 0 0 {name=l9 lab=GND}
C {devices/ind.sym} 370 190 1 0 {name=L4
m=1
value=1.5n
footprint=1206
device=inductor}
C {devices/lab_wire.sym} 240 20 0 0 {name=l10 sig_type=std_logic lab=VDD}
C {devices/res.sym} 240 60 0 0 {name=Rsense2
value=1m
footprint=1206
device=resistor
m=1}
