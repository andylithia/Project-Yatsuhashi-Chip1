...
S {}
E {}
C {devices/code_shown.sym} 80 -30 0 0 {name=s1 only_toplevel=false value="X0 m1_440_420# IREF VHI VHI sky130_fd_pr__pfet_01v8 ad=0p pd=0u as=0p ps=0u w=5e+06u l=1e+06u
...
"}
C {devices/iopin.sym} -120 -130 0 0 {name=p1 lab=IREF}
C {devices/iopin.sym} -120 -100 0 0 {name=p2 lab=A}
C {devices/iopin.sym} -120 -70 0 0 {name=p3 lab=B}
C {devices/iopin.sym} -120 -40 0 0 {name=p4 lab=C}
C {devices/iopin.sym} -120 -10 0 0 {name=p5 lab=D}
C {devices/iopin.sym} -120 20 0 0 {name=p6 lab=R}
C {devices/iopin.sym} -120 50 0 0 {name=p7 lab=VSUBS}
C {devices/iopin.sym} -120 -160 0 0 {name=p8 lab=VHI}
