...
X86 VHI G32 pmirror_pfet_64x_flat_0/G32 VHI sky130_fd_pr__pfet_01v8 ad=0p pd=0u as=0p ps=0u w=30e+06u l=150000u
X87 VHI G16 pmirror_pfet_64x_flat_0/G16 VHI sky130_fd_pr__pfet_01v8 ad=0p pd=0u as=0p ps=0u w=30e+06u l=150000u
X88 VHI G2 pmirror_pfet_64x_flat_0/G2 VHI sky130_fd_pr__pfet_01v8 ad=0p pd=0u as=0p ps=0u w=30e+06u l=150000u
X89 VHI G4 pmirror_pfet_64x_flat_0/G4 VHI sky130_fd_pr__pfet_01v8 ad=0p pd=0u as=0p ps=0u w=30e+06u l=150000u
X90 VHI G8 pmirror_pfet_64x_flat_0/G8 VHI sky130_fd_pr__pfet_01v8 ad=0p pd=0u as=0p ps=0u w=30e+06u l=150000u
...
"}
C {devices/ipin.sym} -80 360 0 0 {name=p1 lab=G2}
C {devices/ipin.sym} -80 380 0 0 {name=p2 lab=G4}
C {devices/ipin.sym} -80 400 0 0 {name=p3 lab=G8}
C {devices/ipin.sym} -80 420 0 0 {name=p4 lab=G16}
C {devices/ipin.sym} -80 440 0 0 {name=p5 lab=G32}
C {devices/iopin.sym} 0 360 2 0 {name=p6 lab=VHI}
C {devices/iopin.sym} 0 380 2 0 {name=p7 lab=VSUBS}
C {devices/iopin.sym} 0 400 2 0 {name=p8 lab=IREF}
C {devices/iopin.sym} 0 420 2 0 {name=p9 lab=IOUT}
