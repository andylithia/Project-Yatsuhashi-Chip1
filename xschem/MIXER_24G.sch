...
.endc
"}
C {devices/code.sym} 1520 -1150 0 0 {name=SS_MODELS only_toplevel=false
...
C {devices/vsource.sym} 430 -850 0 0 {name=V2 value="SIN(0.9 0.9 24G 0 0 180)"
}
C {devices/vsource.sym} 960 -850 0 0 {name=V3 value="SIN(0.9 0.9 24G 0 0 0)"
}
...
C {devices/vsource.sym} 560 -710 0 0 {name=V4 value="SIN(0.9 0.1 24.5G 0 0 0)"
}
...
C {devices/vsource.sym} 1080 -710 0 0 {name=V5 value="SIN(0.9 0.1 24.5G 0 0 180)"
}
C {devices/lab_wire.sym} 480 -1110 0 0 {name=l7 sig_type=std_logic lab=vop}
C {devices/lab_wire.sym} 690 -910 0 0 {name=l6 sig_type=std_logic lab=vmid1}
C {devices/lab_wire.sym} 1230 -910 0 0 {name=l8 sig_type=std_logic lab=vmid2}
