...
"}
C {devices/code_shown.sym} 1520 -1040 0 0 {name=s2 only_toplevel=false value=".subckt nfet_diode_1 IREF_L GND
...
.subckt PA_core_1 DRAIN MID VSUB GATE TOPBIAS_R TOPBIAS_L G1 G2
	...
	.ends
XRF_nfet_3v_dnwell_cascode_0 DRAIN G2 G1
+ MID VSUB VSUB RF_nfet_3v_dnwell_cascode
XRF_nfet_driver_64x8_0 GATE MID VSUB RF_nfet_driver_64x8
Xsky130_fd_pr__res_high_po_0p35_ZE2H5K_0 G2 VSUB TOPBIAS_L
+ sky130_fd_pr__res_high_po_0p35_ZE2H5K
Xsky130_fd_pr__res_high_po_0p35_ZE2H5K_1 TOPBIAS_R VSUB G1
+ sky130_fd_pr__res_high_po_0p35_ZE2H5K
...
C {devices/vsource.sym} 640 -210 0 0 {name=V1 value=1.4}
...
C {devices/isource.sym} 270 -70 0 0 {name=I1 value=8m}
...
footprint=1206
device="ceramic capacitor"}
C {devices/vsource.sym} 420 50 0 0 {name=V2 value=0.9}
C {devices/gnd.sym} 420 80 0 0 {name=l7 lab=GND}
C {devices/capa.sym} 720 100 0 0 {name=C4
m=1
value=2p

footprint=1206
device="ceramic capacitor"}
C {devices/vsource.sym} 180 310 0 0 {name=V4 value="SIN(0 0.3 5G)"}
C {devices/gnd.sym} 180 340 0 0 {name=l8 lab=GND}
C {devices/res.sym} 210 190 1 0 {name=R1
value=50
footprint=1206
device=resistor
m=1}
C {devices/vsource.sym} 180 250 0 0 {name=V5 value="SIN(0 0.3 5.5G)"}
